        ...
        <div className="w-main flex flex-col gap-4">
          <div className="grid grid-cols-2">
            <div className="col-span-1 text-sm text-[#505050]">
              ...
              <p>
                To edit the content on this page, go to the Pages section of
                your Shopify admin.
              </p>
            </div>
            <div className="col-span-1">
              <img
                src="https://cdn.shopify.com/s/files/1/1636/8779/files/digital_marketingSM_large.jpg?v=1487217022"
                alt=""
              />
            </div>
          </div>
